...
arduino_data=serial.Serial('COM3',baudrate=1000000)
time.sleep(2)
...
class monitoring():
    class testing_inputs_and_playing_alarms():
        ...
        notification_label_pressure=Label(window, text="f this", bg="red", fg="white",font=("montserrat",10,"normal"))
        notification_label_flowrate=Label(window, text="f this", bg="red", fg="white",font=("montserrat",10,"normal"))
        notification_label_peep=Label(window, text="f this", bg="red", fg="white",font=("montserrat",10,"normal"))
        notification_label_pplat=Label(window, text="f this", bg="red", fg="white",font=("montserrat",10,"normal"))
        notification_label_bpm=Label(window, text="f this", bg="red", fg="white",font=("montserrat",10,"normal"))
        notification_label_oxygen=Label(window, text="f this", bg="red", fg="white",font=("montserrat",10,"normal"))
    ...
    class receiving_data_from_arduino():
        def grab_raw_input_from_arduino():
            ...
            data_received="PP,150,FR,50,PEEP,333,PPl,1231,bpm,1231,IE,1:1231,FiO2,1,VTI,1000,VTE,123,fan,1"
        ...
        def convert_raw_input_into_values():
            ...
            value_pplat_received=float(opened_string[7])*0.0102
            value_bpm_received=int(opened_string[9])
            value_IE_received=str(opened_string[11])
            # if (value_IE_received != " INF"):
            #     value_IE_received = float(value_IE_received)
            # # "{:.1f}".
            # print(value_IE_received)
            ...
            # A=0.0001767375
            # CALIBRATED AIR SPEED: https://en.wikipedia.org/wiki/Airspeed, https://en.wikipedia.org/wiki/Calibrated_airspeed

            # value_pressure_received_5 = (0.5)*(1.225)*(  ( (value_flow_received_5/(60000*0.0001767375)) ) ** 2  )
            # value_pressure_received_5 = value_pressure_received_5*0.0102
            # value_pressure_received_5 = value_pressure_received_5/(0.0102) + (0.5)*(1.145656)*(  ( (value_flow_received_5/(60000*0.0001767375)) ) ** 2  )
    ...
    class display_values_being_monitored():
        ...
        y_increment_monitored_values_block=180
        ...
        def display_Peak_Pressure(Peak_Pressure,max,min):
            ...
            Peak_P_maximum=Label(window, text=max, bg="black", fg="white",font=("montserrat light",9,"normal"))
            Peak_P_minimum=Label(window, text=min, bg="black", fg="white",font=("montserrat light",9,"normal"))
            Peak_P_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_insp_flowrate(Flowrate,max,min):
            ...
            flowrate_maximum=Label(window, text=max, bg="black", fg="white",font=("montserrat light",9,"normal"))
            flowrate_minimum=Label(window, text=min, bg="black", fg="white",font=("montserrat light",9,"normal"))
            flowrate_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_PEEP(PEEP,max,min):
            ...
            y_increment=65
            x_increment_text_right=30        #use this to change gap b/w number and text to its right
            PEEP_number=Label(window, text=PEEP, anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
            ...
            PEEP_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_P_plat(P_plat,max,min):
            ...
            y_increment=65
            x_increment_text_right=30        #use this to change gap b/w number and text to its right
            P_plat_number=Label(window, text=P_plat, anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
            ...
            P_plat_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_BPM(BPM,max,min):
            ...
            y_increment=65
            x_increment_text_right=30        #use this to change gap b/w number and text to its right
            BPM_number=Label(window, text=BPM, anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
            ...
            BPM_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_VTE(VTE,max,min):
            ...
            VTE_number=Label(window, text=VTE, anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
        ...
        def display_VTI(VTI,max,min):
            ...
            y_increment=65
            x_increment_text_right=30
            VTI_number=Label(window, text=VTI, anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
        ...
        def display_IE(IE,max,min):
            ...
            y_increment=65
            x_increment_text_right=30        #use this to change gap b/w number and text to its right
            IE_number=Label(window, text="1:"+str(IE), anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
            ...
            IE_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_FiO2(FiO2,max,min):
            ...
            y_increment=65
            x_increment_text_right=30
            FiO2_number=Label(window, text=FiO2, anchor="w", bg="black", fg="white",font=("montserrat",34,"normal"))
            ...
            FiO2_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def display_breathing_status(breathing_status,max,min):
            ...
            # breathing_status_number.place(x=90+x_increment,y=y_increment_monitored_values_block+40+line*y_increment)
        ...
        def configure_monitored_values():
            ...
            # IE_number.configure(text="{:.1f}".float(str(value_IE_received)))
            FiO2_number.configure(text=str(value_oxygen_received))
    ...
    def live_updates():
        ...
        if testing_time_start<testing_time_end:
            window.after(14,monitoring.live_updates)
...
class ventilation_inputs():
    ...
    class CustomScale(ttk.Scale):
        ...
        def _update_text(self, *args):
            ...
            global value_pressure_entered_at_beginning_of_scale
            global value_flowrate_entered_at_beginning_of_scale
            global value_vol_entered_at_beginning_of_scale
            global value_bpm_entered_at_beginning_of_scale
            global value_peep_entered_at_beginning_of_scale
            global value_oxygen_entered_at_beginning_of_scale
            global value_insp_time_entered_at_beginning_of_scale
            global value_ie_entered_at_beginning_of_scale
            global value_triggering_flow_entered_at_beginning_of_scale
            global value_triggering_pressure_entered_at_beginning_of_scale

            global cross_cutter                     #cross cutter is 0 whenever you just start using the scale. It saves the scale's initial value and if you press cross instead of tick, it destroys wherever you left the scale and sets all values back to where they were before the scale was iniiated. Doing this destroys any changes made in the value when cross is pressed rather than tick
            if cross_cutter==0:
                value_pressure_entered_at_beginning_of_scale = value_pressure_entered
                value_flowrate_entered_at_beginning_of_scale = value_flowrate_entered
                value_vol_entered_at_beginning_of_scale = value_vol_entered
                value_bpm_entered_at_beginning_of_scale = value_bpm_entered
                value_peep_entered_at_beginning_of_scale = value_peep_entered
                value_oxygen_entered_at_beginning_of_scale = value_oxygen_entered
                value_insp_time_entered_at_beginning_of_scale = value_insp_time_entered
                value_ie_entered_at_beginning_of_scale = value_ie_entered
                value_triggering_flow_entered_at_beginning_of_scale = value_triggering_flow_entered
                value_triggering_pressure_entered_at_beginning_of_scale = value_triggering_pressure_entered
                packed_pressure="p"+","+str(value_pressure_entered)+","
                packed_flowrate="q"+","+str(value_flowrate_entered)+","
                packed_vol="v"+","+str(value_vol_entered)+","
                packed_bpm="b"+","+str(value_bpm_entered)+","
            ...
            if property_being_updated=="Tidal Volume":
                ...
                packed_vol="v"+","+str(value_vol_entered)+","
                value_flowrate_entered = float(value_vol_entered) / float(value_insp_time_entered)
                value_flowrate_entered = "{:.2f}".format(value_flowrate_entered*60/1000)
            if property_being_updated=="BPM":
                value_bpm_entered=format(int(self.variable.get()))
                packed_bpm="b"+","+str(value_bpm_entered)+","
                # exp_time = (60/float(value_bpm_entered)) - float(value_insp_time_entered)         #these two lines update I:E as per BPM
                # value_ie_entered = int(exp_time/float(value_insp_time_entered))
                value_insp_time_entered = ( 60 / ((float(value_bpm_entered)) * (1+float(value_ie_entered))) )   # these two lines change insp_time depending on BPM
                value_insp_time_entered = "{:.2f}".format(value_insp_time_entered)

                value_flowrate_entered = float(value_vol_entered) / float(value_insp_time_entered)  # mL/s
                value_flowrate_entered = "{:.2f}".format(value_flowrate_entered*60/1000)
            ...
            if property_being_updated=="insp_time":
                ...
                # value_insp_time_entered=format(self.variable.get())
                value_insp_time_entered="{:.2f}".format((self.variable.get()))                     #keeping inspiratory time accurate to 2 decimal places so we can have fine inspiratory times. we need values b/w 0 and 1 as well
                packed_insp_time="it"+","+str(value_insp_time_entered)+","
                exp_time = (60/float(value_bpm_entered)) - float(value_insp_time_entered)          #these two lines update I:E as per insp_time
                value_ie_entered = int(exp_time/float(value_insp_time_entered))
            ...
            if property_being_updated=="ie":
                ...
                packed_ie="ie"+","+"1:"+str(value_ie_entered)+","
                value_insp_time_entered = ( 60 / ((float(value_bpm_entered)) * (1+float(value_ie_entered))) )   # these two lines change insp_time depending on IE
                value_insp_time_entered = "{:.2f}".format(value_insp_time_entered)
            ...
            if property_being_updated=="Triggering pressure":
                ...
                packed_triggering_pressure="tp"+","+str(value_triggering_pressure_entered)+","
            if property_being_updated=="ie":                                                        #I:E is displayed differently, with a "1:"
                scale_value=Label(window, text="1:"+str(int(self.variable.get())), bg="black", fg="white",font=("montserrat semi bold",30,"normal"))
                scale_label=Label(window, text=property_being_updated, bg="black", fg="white",font=("montserrat light",12,"normal"))
            if property_being_updated != "ie":
                if property_being_updated == "insp_time":                                           #insp_time is 2 decimal places and others are integers, so it's different
                    scale_value=Label(window, text="{:.2f}".format((self.variable.get())), bg="black", fg="white",font=("montserrat semi bold",30,"normal"))
                if property_being_updated != "insp_time":                                           #other values
    ...
    def cross_pressed():
        ...
        global packed_triggering_pressure
        global cross_cutter
        if cross_cutter==1:                                                             #cross cutter is 0 whenever you just start using the scale. It saves the scale's initial value and if you press cross instead of tick, it destroys wherever you left the scale and sets all values back to where they were before the scale was iniiated. Doing this destroys any changes made in the value when cross is pressed rather than tick
            value_pressure_entered = value_pressure_entered_at_beginning_of_scale
            value_flowrate_entered = value_flowrate_entered_at_beginning_of_scale
            value_vol_entered = value_vol_entered_at_beginning_of_scale
            value_bpm_entered = value_bpm_entered_at_beginning_of_scale
            value_peep_entered = value_peep_entered_at_beginning_of_scale
            value_oxygen_entered = value_oxygen_entered_at_beginning_of_scale
            value_insp_time_entered = value_insp_time_entered_at_beginning_of_scale
            value_ie_entered = value_ie_entered_at_beginning_of_scale
            value_triggering_flow_entered = value_triggering_flow_entered_at_beginning_of_scale
            value_triggering_pressure_entered = value_triggering_pressure_entered_at_beginning_of_scale
            packed_pressure ="p"+","+str(value_pressure_entered)+","
            packed_flowrate ="q"+","+str(value_flowrate_entered)+","
            packed_vol ="v"+","+str(value_vol_entered)+","
            packed_bpm ="b"+","+str(value_bpm_entered)+","
...
class startup_inputs():
    ...
    def update_cmv():
        ...
        x_ventilation_modes_second_line = 725
        x_ventilation_modes_third_line = 1200
        x_gap_between_buttons = 90
    ...
    def update_pcv():
        ...
        y_first_line_ventilation_modes = 635
        y_distance_between_lines_ventilation_modes = 50
        pcv_green_image_startup_button.place(x=x_ventilation_modes_second_line , y=y_first_line_ventilation_modes)
        vcv_blank_image_startup_button.place(x=x_ventilation_modes_second_line+1*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        startup_inputs.hide_everything_in_startup()
    ...
    def update_vcv():
        ...
        y_first_line_ventilation_modes = 635
        y_distance_between_lines_ventilation_modes = 50
        pcv_blank_image_startup_button.place(x=x_ventilation_modes_second_line , y=y_first_line_ventilation_modes)
        vcv_green_image_startup_button.place(x=x_ventilation_modes_second_line+1*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        startup_inputs.hide_everything_in_startup()
        startup_inputs.startup_protocol()
    vcv_blank_image=PhotoImage(file="vcv_blank.gif")
    ...
    def update_pressure_trigger_mode():
        ...
        y_first_line_ventilation_modes = 635
        y_distance_between_lines_ventilation_modes = 50
        Pressure_triggered_green_image_startup_button.place(x=x_ventilation_modes_third_line , y=y_first_line_ventilation_modes)
        Flow_triggered_blank_image_startup_button.place(x=x_ventilation_modes_third_line+1.5*x_gap_between_buttons , y=y_first_line_ventilation_modes)
    ...
    def update_flow_trigger_mode():
        ...
        y_first_line_ventilation_modes = 635
        y_distance_between_lines_ventilation_modes = 50
        Pressure_triggered_blank_image_startup_button.place(x=x_ventilation_modes_third_line , y=y_first_line_ventilation_modes)
        Flow_triggered_green_image_startup_button.place(x=x_ventilation_modes_third_line+1.5*x_gap_between_buttons , y=y_first_line_ventilation_modes)
    ...
    def place_flow_trigger_scale():
        ...
        line=line_no-1
        property_flow_trigger=Label(window, text="Trig. Flow", bg="black", fg="white",font=("montserrat",18,"normal"))
        unit_flow_trigger_left=Label(window, text="Lpm", bg="black", fg="white",font=("montserrat light",9,"normal"))
        ...
        flow_trigger_scale_unit_label=Label(window, text="Lpm", bg="black", fg="white",font=("montserrat light",9,"normal"))
...
def time_testing_display():
    ...
    if testing_time_start<testing_time_end:
        window.after(14,time_testing_display)
