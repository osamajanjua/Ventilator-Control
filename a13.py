...
#         line=line_no-1
#         if mode==",pcv,":
#             property_p_insp=Label(window, text="Pressure UL", bg="black", fg="white",font=("montserrat",18,"normal"))
#             unit_p_insp_left=Label(window, text="cmH20", bg="black", fg="white",font=("montserrat light",9,"normal"))
#             property_p_insp.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment)
#             unit_p_insp_left.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment+y_unit_increment)
...
#             alarm_scale_pressure_value_UA.place(x=scale_value_pressure_entered_location_x_UA,y=scale_value_pressure_entered_location_y_UA, anchor = CENTER)
#             p_scale_unit_label.place(x=line_1_x+x_increment_UL+x_display_increment,y=3+line_1_y+line*y_increment+y_unit_increment+y_display_increment, anchor = CENTER)
#             # line_no=1
#             # line=line_no-1
#             property_p_insp=Label(window, text="Pressure LL", bg="black", fg="white",font=("montserrat",18,"normal"))
#             unit_p_insp_left=Label(window, text="cmH20", bg="black", fg="white",font=("montserrat light",9,"normal"))
...
#         if mode==",vcv,":
#             property_flowrate=Label(window, text="Flowrate UL", bg="black", fg="white",font=("montserrat",18,"normal"))
#             unit_flowrate_left=Label(window, text="Lpm", bg="black", fg="white",font=("montserrat light",9,"normal"))
#             property_flowrate.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment)
#             unit_flowrate_left.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment+y_unit_increment)
...
#             alarm_scale_flowrate_value_UA.place(x=scale_value_flowrate_entered_location_x_UA,y=scale_value_flowrate_entered_location_y_UA, anchor = CENTER)
#             flowrate_scale_unit_label.place(x=line_1_x+x_increment_UL+x_display_increment,y=3+line_1_y+line*y_increment+y_unit_increment+y_display_increment, anchor = CENTER)
#             # line_no=2
#             # line=line_no-1
#             property_flowrate=Label(window, text="Flowrate LL", bg="black", fg="white",font=("montserrat",18,"normal"))
#             unit_flowrate_left=Label(window, text="Lpm", bg="black", fg="white",font=("montserrat light",9,"normal"))
...
#         line_no=2
#         line=line_no-1
#         property_peep=Label(window, text="PEEP UL", bg="black", fg="white",font=("montserrat",18,"normal"))
#         unit_peep=Label(window, text="cmH20", bg="black", fg="white",font=("montserrat light",9,"normal"))
#         property_peep.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment)
#         unit_peep.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment+y_unit_increment)
...
#         alarm_scale_peep_value_UA.place(x=scale_value_peep_entered_location_x_UA,y=scale_value_peep_entered_location_y_UA, anchor = CENTER)
#         peep_scale_unit_label.place(x=line_1_x+x_increment_UL+x_display_increment,y=3+line_1_y+line*y_increment+y_unit_increment+y_display_increment, anchor = CENTER)
#         # line_no=4
#         # line=line_no-1
#         property_peep=Label(window, text="PEEP LL ", bg="black", fg="white",font=("montserrat",18,"normal"))
#         unit_peep=Label(window, text="cmH20", bg="black", fg="white",font=("montserrat light",9,"normal"))
...
#         line_no=3
#         line=line_no-1
#         property_bpm=Label(window, text="BPM UL", bg="black", fg="white",font=("montserrat",18,"normal"))
#         property_bpm.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment)
...
#         # line_no=6
#         # line=line_no-1
#         property_bpm=Label(window, text="BPM LL", bg="black", fg="white",font=("montserrat",18,"normal"))
...
#         line_no=4
#         line=line_no-1
#         property_oxygen=Label(window, text="Oxygen UL", bg="black", fg="white",font=("montserrat",18,"normal"))
#         unit_oxygen_left=Label(window, text="%", bg="black", fg="white",font=("montserrat light",9,"normal"))
#         property_oxygen.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment)
#         unit_oxygen_left.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment+y_unit_increment)
...
#         alarm_scale_oxygen_value_UA.place(x=scale_value_oxygen_entered_location_x_UA,y=scale_value_oxygen_entered_location_y_UA, anchor = CENTER)
#         oxygen_scale_unit_label.place(x=line_1_x+x_increment_UL+x_display_increment,y=3+line_1_y+line*y_increment+y_unit_increment+y_display_increment, anchor = CENTER)
#         # line_no=8
#         # line=line_no-1
#         property_oxygen=Label(window, text="Oxygen LL", bg="black", fg="white",font=("montserrat",18,"normal"))
#         unit_oxygen_left=Label(window, text="%", bg="black", fg="white",font=("montserrat light",9,"normal"))
...
#             line_no=5
#             line=line_no-1
#             property_vol=Label(window, text="Volume UL", bg="black", fg="white",font=("montserrat",18,"normal"))
#             unit_vol_left=Label(window, text="mL", bg="black", fg="white",font=("montserrat light",9,"normal"))
#             property_vol.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment)
#             unit_vol_left.place(x=line_1_x+x_increment_UL,y=line_1_y+line*y_increment+y_unit_increment)
...
#             alarm_scale_vol_value_UA.place(x=scale_value_vol_entered_location_x_UA,y=scale_value_vol_entered_location_y_UA, anchor = CENTER)
#             vol_scale_unit_label.place(x=line_1_x+x_increment_UL+x_display_increment,y=3+line_1_y+line*y_increment+y_unit_increment+y_display_increment, anchor = CENTER)
#             # line_no=10
#             # line=line_no-1
#             property_vol=Label(window, text="Volume LL", bg="black", fg="white",font=("montserrat",18,"normal"))
#             unit_vol_left=Label(window, text="mL", bg="black", fg="white",font=("montserrat light",9,"normal"))
...
#     def stop_updating_alarms():
#         print("stop")
#     alarm_stop_updating=PhotoImage(file="alarms_green.gif")
#     alarm_stop_updating_button=Button(window, image=alarm_stop_updating, highlightthickness=0,bd=0,bg="white",command=stop_updating_alarms)
#
#     def update_alarms():
#         graphs.hide_graphs()
#         monitoring.display_values_being_monitored.hide_monitored_values()
...
#     alarm_updates_button=Button(window, image=alarm_updates, highlightthickness=0,bd=0,bg="white",command=update_alarms)
"""CLASS: ALARM/END"""
...
class ventilation_inputs():
    ...
    def update_acv():
        ...
        x_ventilation_modes_first_line = 1240
        x_ventilation_modes_second_line = 1300
        x_ventilation_modes_third_line = 1280
        x_gap_between_buttons = 90
        y_first_line_ventilation_modes = 75
        y_distance_between_lines_ventilation_modes = 50
        acv_green_image_button.place(x=x_ventilation_modes_first_line , y=y_first_line_ventilation_modes)
        simv_blank_image_button.place(x=x_ventilation_modes_first_line+1*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        cpap_blank_image_button.place(x=x_ventilation_modes_first_line+2*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        send_data_to_arduino()
    ...
    def update_simv():
        ...
        y_first_line_ventilation_modes = 75
        y_distance_between_lines_ventilation_modes = 50
        acv_blank_image_button.place(x=x_ventilation_modes_first_line , y=y_first_line_ventilation_modes)
        simv_green_image_button.place(x=x_ventilation_modes_first_line+1*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        cpap_blank_image_button.place(x=x_ventilation_modes_first_line+2*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        send_data_to_arduino()
    ...
    def update_cpap():
        ...
        acv_blank_image_button.place(x=x_ventilation_modes_first_line , y=y_first_line_ventilation_modes)
        simv_blank_image_button.place(x=x_ventilation_modes_first_line+1*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        cpap_green_image_button.place(x=x_ventilation_modes_first_line+2*x_gap_between_buttons , y=y_first_line_ventilation_modes)
        send_data_to_arduino()
...
# alarm_updates=PhotoImage(file="alarms.gif")
# alarm_updates_button=Button(window, image=alarm_updates, highlightthickness=0,bd=0,bg="white",command=alarm_scales.update_alarms)
# alarm_updates_button.place(x=50,y=50)
# alarm_scales.place_alarm_scales()
