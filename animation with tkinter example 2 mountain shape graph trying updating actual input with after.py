...
def update_plot_data():
	...
	y_val_pressure=y_val_pressure+1
	window.after(time, update_plot_data)
	if y_val_pressure==10:
		y_val_pressure=0
update_plot_data()
...
animation_pressure = FuncAnimation(fig_pressure, func=animation_frame_pressure, frames=1000, interval=time)
