...
arduino_data=serial.Serial('COM8',baudrate=1000000)
time.sleep(2)
...
packed_flowrate="f"+","+str(value_flowrate_entered)+","
...
class monitoring():
    class testing_inputs_and_playing_alarms():
        ...
        notification_label_pressure=Label(window, text="fuck this", bg="red", fg="white",font=("montserrat light",12,"normal"))
        notification_label_flowrate=Label(window, text="fuck this", bg="red", fg="white",font=("montserrat light",12,"normal"))
        notification_label_peep=Label(window, text="fuck this", bg="red", fg="white",font=("montserrat light",12,"normal"))
        notification_label_pplat=Label(window, text="fuck this", bg="red", fg="white",font=("montserrat light",12,"normal"))
        notification_label_bpm=Label(window, text="fuck this", bg="red", fg="white",font=("montserrat light",12,"normal"))
        notification_label_oxygen=Label(window, text="fuck this", bg="red", fg="white",font=("montserrat light",12,"normal"))
        ...
        def testing_received_values():
            ...
            if mode==",pcv,":
                if value_pressure_received_5<=LL_pressure:
                    notification_label_pressure.configure(text="Pressure kam ee", bg="yellow", fg="black")
                if value_pressure_received_5>=UL_pressure:
                    notification_label_pressure.configure(text="Pressure baun zada ee", bg="red", fg="white")
            ...
            if mode==",vcv,":
                if value_flow_received_5<=LL_flowrate:
                    notification_label_flowrate.configure(text="flow kam ee", bg="yellow", fg="black")
                if value_flow_received_5>=UL_flowrate:
                    notification_label_flowrate.configure(text="flow baun zada ee", bg="red", fg="white")
            ...
            if len(opened_string)>13:
                ...
                if value_peep_received<=LL_peep:
                    notification_label_peep.configure(text="peep kam ee", bg="yellow", fg="black")
                if value_peep_received>=UL_peep:
                    notification_label_peep.configure(text="peep baun zada ee", bg="red", fg="white")
                ...
                if value_pplat_received<=LL_pplat:
                    notification_label_pplat.configure(text="pplat kam ee", bg="yellow", fg="black")
                if value_pplat_received>=UL_pplat:
                    notification_label_pplat.configure(text="pplat baun zada ee", bg="red", fg="white")
                ...
                if value_bpm_received<=LL_bpm:
                    notification_label_bpm.configure(text="bpm kam ee", bg="yellow", fg="black")
                if value_bpm_received>=UL_bpm:
                    notification_label_bpm.configure(text="bpm baun zada ee", bg="red", fg="white")
                ...
                if value_oxygen_received<=LL_oxygen:
                    notification_label_oxygen.configure(text="oxygen kam ee", bg="yellow", fg="black")
                if value_oxygen_received>=UL_oxygen:
                    notification_label_oxygen.configure(text="oxygen baun zada ee", bg="red", fg="white")
    ...
    class receiving_data_from_arduino():
        def grab_raw_input_from_arduino():
            ...
            # data_received="PP,150,150,150,150,150,FR,5,5,5,5,5,PEEP,31,PPl,32,bpm,16,IE,1:2,FiO2,50,V,2000,fan,1"
        ...
        def convert_raw_input_into_values():
            ...
            # print(opened_string)
            # print("length", len(opened_string))
            value_pressure_received_1=float(opened_string[1])*0.0102
            value_pressure_received_2=float(opened_string[2])*0.0102
            value_pressure_received_3=float(opened_string[3])*0.0102
            value_pressure_received_4=float(opened_string[4])*0.0102
            value_pressure_received_5=float(opened_string[5])*0.0102
            # print(opened_string[1], opened_string[2], opened_string[3], opened_string[4], opened_string[5])
            value_flow_received_1=float(opened_string[7])
            value_flow_received_2=float(opened_string[8])
            value_flow_received_3=float(opened_string[9])
            value_flow_received_4=float(opened_string[10])
            value_flow_received_5=float(opened_string[11])
            value_peep_received=float(opened_string[13])*0.0102
            value_pplat_received=int(opened_string[15])*0.0102
            value_bpm_received=int(opened_string[17])
            value_IE_received=str(opened_string[19])
            value_oxygen_received=int(opened_string[21])
            value_vol_received=int(opened_string[23])
            breathing_status_received=str(opened_string[24])
            # if len(opened_string)>=13:
            #     value_pressure_received_1=float(opened_string[1])*0.0102
            #     value_pressure_received_2=float(opened_string[2])*0.0102
            #     value_pressure_received_3=float(opened_string[3])*0.0102
            ...
            # if len(opened_string)>13:
            #     value_peep_received=float(opened_string[13])*0.0102
            #     value_pplat_received=int(opened_string[15])
            #     value_bpm_received=int(opened_string[17])
            #     value_IE_received=str(opened_string[19])
            #     value_oxygen_received=int(opened_string[21])
            #     value_vol_received=int(opened_string[23])
    ...
    class display_values_being_monitored():
        ...
        def display_insp_flowrate(Flowrate,max,min):
            ...
            flowrate_label=Label(window, text="Peak Pressure", bg="black", fg="white",font=("montserrat light",12,"normal"))
            flowrate_unit=Label(window, text="cmH20", bg="black", fg="white",font=("montserrat light",12,"normal"))
        ...
        def configure_monitored_values():
            ...
            VTE_number.configure(text=int(value_vol_received))
            IE_number.configure(text=str(value_IE_received))
            FiO2_number.configure(text=value_oxygen_received)
        ...
        def display_monitored_values():
            ...
            if mode==",vcv,":
                monitoring.display_values_being_monitored.display_insp_flowrate(value_pressure_received_5,32,2)
    ...
    class graphs():
        ...
        array_character_number_being_printed_pressure=1
        data_points_in_one_array_pressure=5
        time_interval_pressure=0.150/data_points_in_one_array_pressure
        ...
        def animation_frame_pressure(i):
            # print(value_pressure_received_1, value_pressure_received_2, value_pressure_received_3, value_pressure_received_4, value_pressure_received_5)
            global time_interval_pressure
            global starting_time_pressure
            global y_val_pressure
            global x_data_pressure
            ...
            if animation_loop_counter_pressure<data_points_pressure:
                if array_character_number_being_printed_pressure==1:
                ...
                if array_character_number_being_printed_pressure==2:
                    x_data_pressure=np.append(x_data_pressure,[starting_time_pressure])
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_2])
                if array_character_number_being_printed_pressure==3:
                    x_data_pressure=np.append(x_data_pressure,[starting_time_pressure])
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_3])
                if array_character_number_being_printed_pressure==4:
                    x_data_pressure=np.append(x_data_pressure,[starting_time_pressure])
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_4])
                if array_character_number_being_printed_pressure==5:
                    x_data_pressure=np.append(x_data_pressure,[starting_time_pressure])
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_5])
            if animation_loop_counter_pressure>=data_points_pressure:
                if array_character_number_being_printed_pressure==1:
                    # print("1, ",value_pressure_received_1)
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_1])
                    y_data_pressure=np.delete(y_data_pressure,0)
                if array_character_number_being_printed_pressure==2:
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_2])
                    y_data_pressure=np.delete(y_data_pressure,0)
                    # print("2, ", value_pressure_received_2)
                if array_character_number_being_printed_pressure==3:
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_3])
                    # print("3, ", value_pressure_received_3)
                    y_data_pressure=np.delete(y_data_pressure,0)
                if array_character_number_being_printed_pressure==4:
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_4])
                    y_data_pressure=np.delete(y_data_pressure,0)
                    # print("4, ", value_pressure_received_4)
                if array_character_number_being_printed_pressure==5:
                    y_data_pressure=np.append(y_data_pressure,[value_pressure_received_5])
                    y_data_pressure=np.delete(y_data_pressure,0)
                    # print("5, ", value_pressure_received_5)
            ...
            array_character_number_being_printed_pressure=array_character_number_being_printed_pressure+1
            if array_character_number_being_printed_pressure==6:     #this number will be 6 when array_character_number_being_printed_pressure has hit 5 and thus, all data points have been plotted
                array_character_number_being_printed_pressure=1
        ...
        ax_pressure.set_ylim(-20, 25)
        # line_pressure, = ax_pressure.plot(x_data_pressure, gaussian_filter1d(y_data_pressure, sigma=5), color='white')
        ...
        array_character_number_being_printed_flow=1
        data_points_in_one_array_flow=5
        time_interval_flow=0.150/data_points_in_one_array_flow
        total_time_flow=5
        ...
        def animation_frame_flow(i):
            ...
            if animation_loop_counter_flow<data_points_flow:
                if array_character_number_being_printed_flow==1:
                    x_data_flow=np.append(x_data_flow,[starting_time_flow])
                    y_data_flow=np.append(y_data_flow,[value_flow_received_1])
                if array_character_number_being_printed_flow==2:
                    x_data_flow=np.append(x_data_flow,[starting_time_flow])
                    y_data_flow=np.append(y_data_flow,[value_flow_received_2])
                if array_character_number_being_printed_flow==3:
                    x_data_flow=np.append(x_data_flow,[starting_time_flow])
                    y_data_flow=np.append(y_data_flow,[value_flow_received_3])
                if array_character_number_being_printed_flow==4:
                    x_data_flow=np.append(x_data_flow,[starting_time_flow])
                    y_data_flow=np.append(y_data_flow,[value_flow_received_4])
                if array_character_number_being_printed_flow==5:
                    x_data_flow=np.append(x_data_flow,[starting_time_flow])
            ...
            array_character_number_being_printed_flow=array_character_number_being_printed_flow+1
            if array_character_number_being_printed_flow==6:     #this number will be 6 when array_character_number_being_printed_flow has hit 5 and thus, all data points have been plotted
                array_character_number_being_printed_flow=1
            return line_flow,
        global line_flow
    ...
    def live_updates():
        ...
        if testing_time_start<testing_time_end:
            window.after(150,monitoring.live_updates)
...
class ventilation_inputs():
    ...
    def create_labels_that_show_me_my_inputs():
        ...
        if trigger_mode=="F":
            ...
            unit_displayed_triggering_flow_entered= Label(window, text="cmH20",   bg="black", fg="white",font=("montserrat light",9,"normal"))
    ...
    def place_my_inputs():
        ...
        y_increment=65
        line_1_x=1350
        line_1_y=70+y_increment_monitored_values_block
        line_number=1
        line=line_number-1
        if mode==",pcv,":
...
def time_testing_display():
    ...
    if testing_time_start<testing_time_end:
        window.after(150,time_testing_display)
...
def send_data_to_arduino():
    ...
    if mode==",pcv,":
        if trigger_mode=="P":
            str_pack=str(len(mode))+"s"+str(len(packed_pressure))+"s"+str(len(packed_peep))+"s"+str(len(packed_oxygen))+"s"+str(len(packed_bpm))+"s"+str(len(packed_vol))+"s"+str(len(packed_insp_time))+"s"+str(len(packed_triggering_pressure))+"s"+str(len(packed_ie))+"s"+str(len(packed_manoeuvre))+"s"
            string_to_send=struct.pack(str_pack, mode.encode('UTF-8'), packed_pressure.encode('UTF-8'),packed_peep.encode('UTF-8'),packed_oxygen.encode('UTF-8'),packed_bpm.encode('UTF-8'),packed_vol.encode('UTF-8'),packed_insp_time.encode('UTF-8'),packed_triggering_pressure.encode('UTF-8'),packed_ie.encode('UTF-8'),packed_manoeuvre.encode('UTF-8'))
            print(string_to_send)
            arduino_data.write(string_to_send)
        if trigger_mode=="F":
            str_pack=str(len(mode))+"s"+str(len(packed_pressure))+"s"+str(len(packed_peep))+"s"+str(len(packed_oxygen))+"s"+str(len(packed_bpm))+"s"+str(len(packed_vol))+"s"+str(len(packed_insp_time))+"s"+str(len(packed_triggering_flow))+"s"+str(len(packed_ie))+"s"+str(len(packed_manoeuvre))+"s"
            string_to_send=struct.pack(str_pack, mode.encode('UTF-8'), packed_pressure.encode('UTF-8'),packed_peep.encode('UTF-8'),packed_oxygen.encode('UTF-8'),packed_bpm.encode('UTF-8'),packed_vol.encode('UTF-8'),packed_insp_time.encode('UTF-8'),packed_triggering_flow.encode('UTF-8'),packed_ie.encode('UTF-8'),packed_manoeuvre.encode('UTF-8'))
            print(string_to_send)
            arduino_data.write(string_to_send)
    if mode==",vcv,":
        if trigger_mode=="P":
            str_pack=str(len(mode))+"s"+str(len(packed_flowrate))+"s"+str(len(packed_peep))+"s"+str(len(packed_oxygen))+"s"+str(len(packed_bpm))+"s"+str(len(packed_vol))+"s"+str(len(packed_triggering_pressure))+"s"+str(len(packed_ie))+"s"+str(len(packed_manoeuvre))+"s"
            string_to_send=struct.pack(str_pack, mode.encode('UTF-8'), packed_pressure.encode('UTF-8'),packed_peep.encode('UTF-8'),packed_oxygen.encode('UTF-8'),packed_bpm.encode('UTF-8'),packed_vol.encode('UTF-8'),packed_triggering_pressure.encode('UTF-8'),packed_ie.encode('UTF-8'),packed_manoeuvre.encode('UTF-8'))
            print(string_to_send)
            arduino_data.write(string_to_send)
        if trigger_mode=="F":
            str_pack=str(len(mode))+"s"+str(len(packed_flowrate))+"s"+str(len(packed_peep))+"s"+str(len(packed_oxygen))+"s"+str(len(packed_bpm))+"s"+str(len(packed_vol))+"s"+str(len(packed_triggering_flow))+"s"+str(len(packed_ie))+"s"+str(len(packed_manoeuvre))+"s"
            string_to_send=struct.pack(str_pack, mode.encode('UTF-8'), packed_pressure.encode('UTF-8'),packed_peep.encode('UTF-8'),packed_oxygen.encode('UTF-8'),packed_bpm.encode('UTF-8'),packed_vol.encode('UTF-8'),packed_triggering_flow.encode('UTF-8'),packed_ie.encode('UTF-8'),packed_manoeuvre.encode('UTF-8'))
            print(string_to_send)
            arduino_data.write(string_to_send)
    packed_manoeuvre="m,6,"
    print(string_to_send)
