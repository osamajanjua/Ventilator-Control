...
class alarm_scales():
        ...
        def _update_text(self, *args):
            ...
            if scaling=="yes":
                if scale_location_status=="centered":
                    print("print")
                    print(scale_value_pressure_entered_location_x_UA)
    ...
    def create_alarm_bar_and_slider():
        ...
        # alarm_img_trough = PhotoImage(file="startup_bar.gif")
    ...
    def place_alarm_scales():
        ...
        y_increment_entire_block=40      # change this to move everything up or down
        ...
        x_increment_LL=650                    # use this to change things horizontally rather than editing the value of line_1_x
        x_scale_increment=175            # gap b/w label and scale
        x_display_increment=600          # gap b/w scale and the display to the right side of the scale
        global pressure_UA
        global pressure_LA
        ...
        if mode==",pcv,":
            ...
            scale_alarm_pressure_UA.place(x=line_1_x+x_increment+x_scale_increment,y=y_scale_increment+line_1_y+line*y_increment)
            ...
            scale_value_pressure_entered_location_x_UA=line_1_x+x_increment+x_display_increment
        ...
        if mode==",vcv,":
            ...
            scale_alarm_flowrate_UA.place(x=line_1_x+x_increment+x_scale_increment,y=y_scale_increment+line_1_y+line*y_increment)
            ...
            scale_value_flowrate_entered_location_x_UA=line_1_x+x_increment+x_display_increment
        ...
        scale_alarm_peep_UA.place(x=line_1_x+x_increment+x_scale_increment,y=y_scale_increment+line_1_y+line*y_increment)
        ...
        scale_value_peep_entered_location_x_UA=line_1_x+x_increment+x_display_increment
        ...
        scale_alarm_bpm_UA.place(x=line_1_x+x_increment+x_scale_increment,y=y_scale_increment+line_1_y+line*y_increment)
        alarm_scale_bpm_value_UA=Label(window, text=bpm_UA, bg="black", fg="white",font=("montserrat semi bold",36,"normal"))
        scale_value_bpm_entered_location_x_UA=line_1_x+x_increment+x_display_increment
        ...
        scale_alarm_oxygen_UA.place(x=line_1_x+x_increment+x_scale_increment,y=y_scale_increment+line_1_y+line*y_increment)
        ...
        scale_value_oxygen_entered_location_x_UA=line_1_x+x_increment+x_display_increment
        ...
        if mode==",vcv,":
            line_no=9
            line=line_no-1
            property_vol=Label(window, text="Tidal Volume upper limit", bg="black", fg="white",font=("montserrat",18,"normal"))
            ...
            scale_alarm_vol_UA.place(x=line_1_x+x_increment+x_scale_increment,y=y_scale_increment+line_1_y+line*y_increment)
            ...
            scale_value_vol_entered_location_x_UA=line_1_x+x_increment+x_display_increment
            ...
            line=line_no-1
            property_vol=Label(window, text="Tidal Volume lower limit", bg="black", fg="white",font=("montserrat",18,"normal"))
            unit_vol_left=Label(window, text="mL", bg="black", fg="white",font=("montserrat light",9,"normal"))
            property_vol.place(x=line_1_x+x_increment,y=line_1_y+line*y_increment)
            unit_vol_left.place(x=line_1_x+x_increment,y=line_1_y+line*y_increment+y_unit_increment)
