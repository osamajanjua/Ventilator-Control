...
class monitoring():
    ...
    class receiving_data_from_arduino():
        ...
        def grab_raw_input_from_arduino():
            ...
            global i
            if i==0:
                data_received="PP,1,2,3,4,132,"
            if i==1:
                data_received="PP,1,2,3,4,222,"
            if i==2:
        ...
        def convert_raw_input_into_values():
            ...
            value_vol_received_1=int(opened_string[37])
            value_vol_received_2=int(opened_string[38])
            value_vol_received_3=int(opened_string[39])
            value_vol_received_4=int(opened_string[40])
            value_vol_received_5=int(opened_string[41])
    ...
    class display_values_being_monitored():
        ...
        def configure_monitored_values():
            ...
            PEEP_number.configure(text=value_peep_received_5)
            P_plat_number.configure(text=value_pplat_received_5)
            BPM_number.configure(text=value_bpm_received_5)
            VTE_number.configure(text=value_vol_received_5)
            IE_number.configure(text=value_IE_received_5)
            FiO2_number.configure(text=value_oxygen_received_5)
...
class startup_inputs():
    ...
    def place_startup_scales():
        ...
        startup_scale_ie_value=Label(window, text=LL_ie, bg="black", fg="white",font=("montserrat semi bold",36,"normal"))
