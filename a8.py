...
# from scipy.ndimage.filters import gaussian_filter1d         #smooths out the graphs with gaussian_filter1d. may not be used
    ...
    class receiving_data_from_arduino():
        ...
        def convert_raw_input_into_values():
            ...
            if len(opened_string)>=13:
                ...
                # print("THERE",value_pressure_received_5)
                # "PP,150,150,150,150,150,FR,5,5,5,5,5,PEEP,31,PPl,32,bpm,16,IE,12,FiO2,50,V,2000,2000,2000,2000,2000,"
            if len(opened_string)>13:
